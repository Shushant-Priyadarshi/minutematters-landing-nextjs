    ...
    <main className={styles.body} role="main">
      ...
      <div className={styles.wrapper}>
        ...
        <h1 className={styles.headline}>
          Your time<br />is <em className={styles.em}>precious.</em>
        </h1>

        <p className={styles.subline}>
          Book a doctor or a salon chair in seconds — no calls, no queues, no wasted minutes.
        </p>
        ...
        <div className={styles.cards}>
          ...
          >
            ...
            <p className={styles.cardDesc}>Find and book verified doctors near you, instantly.</p>
            <span className={styles.cardCta}>
              Book now
              <svg width="14" height="14" viewBox="0 0 14 14" fill="none">
                <path d="M2.5 7H11.5M7.5 3L11.5 7L7.5 11" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round" />
              </svg>
            </span>
          </a>
...
>
  ...
  <div className={`${styles.cardIcon} ${styles.salon}`} aria-hidden="true">✂️</div>
  <p className={styles.cardTitle}>Book Salon</p>
  <p className={styles.cardDesc}>Premium salons, real-time slots. Almost here.</p>
  <span className={styles.cardCta}>
    Stay tuned
    <svg width="14" height="14" viewBox="0 0 14 14" fill="none">
      <path d="M2.5 7H11.5M7.5 3L11.5 7L7.5 11" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round" />
          ...
          <div className={styles.socialLinks} aria-label="Social links">
            ...
            >
              <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" width={17} height={17}>
                ...
                <path d="M7 10v7" stroke="currentColor" strokeWidth="1.7" strokeLinecap="round" />
                <circle cx="7" cy="7.5" r="1" fill="currentColor" />
                <path d="M11 17v-3.5a2.5 2.5 0 0 1 5 0V17" stroke="currentColor" strokeWidth="1.7" strokeLinecap="round" strokeLinejoin="round" />
                <path d="M11 10v7" stroke="currentColor" strokeWidth="1.7" strokeLinecap="round" />
              </svg>
            </a>
